...
MSA_PATH="/mnt/nvme/share/msa_datasets/origin"
CKPT_PATH="/mnt/nvme/share/ckpt"
PY_VENV=/mnt/nvme/share/swbind_v1.0/helixfold3-main/.venv
PY_VENV_NVIDIA=$PY_VENV/lib/python3.9/site-packages/nvidia
HMMER_PATH=/mnt/nvme/share/swbind_v1.0/hmmer/bin
...
INPUT_JSON=${2:-"data/demo_8ec1.json"}
OUTPUT_DIR=${3:-"./output"}


CUDA_VISIBLE_DEVICES=1 python /mnt/nvme/share/swbind_v1.0/helixfold3-mmseqs2/inference.py \
    --preset='reduced_dbs' \
    ...
    --uniclust30_database_path "$MSA_PATH/uniclust30/uniclust30_2018_08" \
    --uniprot_database_path "$MSA_PATH/uniprot/uniprot_baidu.fasta" \
    --pdb_seqres_database_path "$MSA_PATH/pdb/baidu/pdb_seqres.txt" \
    --uniref90_database_path "$MSA_PATH/uniref90/uniref90_baidu.fasta" \
    --mgnify_database_path "$MSA_PATH/mgnify/mgy_clusters_2018_12.fa" \
    --template_mmcif_dir "$MSA_PATH/pdb/baidu/mmcif_files" \
    --obsolete_pdbs_path "$MSA_PATH/pdb/baidu/obsolete.dat" \
    --ccd_preprocessed_path "$MSA_PATH/../preprocess/ccd_preprocessed_etkdg.pkl" \
    --rfam_database_path "$MSA_PATH/rfam/rfam_14_9_rep_seq.fasta" \
