...
class DataPipeline:
  ...
  def __init__(self,
    ...
    if use_small_bfd:
      ...
      self.mmseq_small_bfd_runner = mmseqs2.MMseqs2(
        binary_path=mmseqs2_binary_path,
        database_path=small_bfd_database_path
      )
    else:
  ...
  def process(self, input_fasta_path: str, msa_output_dir: str) -> FeatureDict:
    ...
    uniref90_result = run_msa_tool(
        msa_runner=self.jackhmmer_uniref90_runner if self.search_tool == 'hmmer' else self.mmseqs_uniref90_runner,
    ...
    mgnify_result = run_msa_tool(
        msa_runner=self.jackhmmer_mgnify_runner if self.search_tool == 'hmmer' else self.mmseqs_mgnify_runner,
        input_fasta_path=input_fasta_path,
    ...
    msa_for_templates = uniref90_result['sto']
    ...
    uniref90_msa = parsers.parse_stockholm(uniref90_result['sto'])
    mgnify_msa = parsers.parse_stockholm(mgnify_result['sto'])
    ...
    if self._use_small_bfd:
      ...
      small_bfd_result = run_msa_tool(
          msa_runner=self.jackhmmer_small_bfd_runner if self.search_tool == 'hmmer' else self.mmseq_small_bfd_runner,
          input_fasta_path=input_fasta_path,
          msa_out_path=bfd_out_path,
          msa_format='sto',
          use_precomputed_msas=self.use_precomputed_msas)
      bfd_msa = parsers.parse_stockholm(small_bfd_result['sto'])
    else:
